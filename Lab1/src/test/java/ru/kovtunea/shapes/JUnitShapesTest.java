...
public class JUnitShapesTest {
    ...
    @Test
    void testCircleArea() {
        assertEquals(new Circle(0).area(), 0, "Error in getting area from 0 for a circle");
    ...
    void testRectangleArea() {
        assertEquals(new Rectangle(1, 5).area(), 5, "Error in getting area from 1,5 for a rectangle");
    ...
    @Test
    void testSquareArea() {
        assertEquals(new Square(1).area(), 1, "Error in getting area from 1 for a square");
